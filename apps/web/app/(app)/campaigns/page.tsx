      ...
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <div style={{ ...glass, padding: "56px 40px", textAlign: "center" }}>
          ...
          <div style={{
            ...
            border: "1px solid rgba(24,95,165,0.15)", padding: "4px 12px",
            borderRadius: "20px", letterSpacing: "1px", textTransform: "uppercase",
            marginBottom: "14px"
          }}>Coming soon</div>
          <div style={{ fontSize: "20px", fontWeight: 700, color: "#130E08", marginBottom: "8px" }}>
            Campaigns
          </div>
          <div style={{ fontSize: "13px", color: "#B8A898", lineHeight: 1.6, marginBottom: "24px" }}>
            Design, schedule and send beautiful email campaigns<br />to your verified contact list.
          </div>
          <Link href="/contacts">
            <button style={{
