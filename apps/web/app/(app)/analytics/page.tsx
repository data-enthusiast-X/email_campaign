    ...
    <div style={pageBg}>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <div style={{ ...glass, padding: "56px 40px", textAlign: "center" }}>
          ...
          <div style={{ fontSize: "20px", fontWeight: 700, color: "#130E08", marginBottom: "8px" }}>Analytics</div>
          <div style={{ fontSize: "13px", color: "#B8A898", lineHeight: 1.6 }}>Track open rates, click-throughs, unsubscribes,<br />and revenue attribution across all campaigns.</div>
        </div>
      </div>
    </div>
  )
