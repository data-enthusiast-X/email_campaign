    ...
    <div style={pageBg}>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <div style={{ ...glass, padding: "56px 40px", textAlign: "center" }}>
          ...
          <div style={{ fontSize: "20px", fontWeight: 700, color: "#130E08", marginBottom: "8px" }}>Send queue</div>
          <div style={{ fontSize: "13px", color: "#B8A898", lineHeight: 1.6 }}>Live monitor for active email sends.<br />Track delivery, opens, and bounces in real time.</div>
        </div>
      </div>
    </div>
  )
